...
const StandalonePage: FC = () => {
  ...
  const handleOptimize = async () => {
    ...
    try {
      ...
      // Step 5: Get refined prompts
      const { variants } = await promptApi.generateVariants(optimizedPrompt, taskDescription);
      setResults(prev => ({ ...prev, variantPrompts: variants }));

      // Step 6: Test refined prompts
      ...
      <main className="relative z-0">
        <div className="relative mx-auto px-2 py-32 sm:px-4">
          <div className="text-center space-y-8">
            ...
            >
              {t('modes.standalone.description')}
            </motion.p>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-5 gap-8 max-w-[1800px] mx-auto">
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    placeholder={t('modes.standalone.taskDescriptionPlaceholder')}
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    placeholder={t('modes.standalone.initialPromptPlaceholder')}
                    value={initialPrompt}
                ...
                <Button 
                  ...
                  disabled={loading || optimizing || !selectedModel || !taskDescription || !initialPrompt}
                >
                  {optimizing ? (
