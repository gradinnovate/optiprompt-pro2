export interface PromptTemplate {
  final_prompt: string;
  eval_prompt: string;
  quest_reason_ans: string;
  system_prompt: string;
  expert_profile: string;
  thinking_styles: string[];
  ans_delimiter_instruction: string;
  initial_prompt_generation_template: string;
  meta_critique_template: string;
  meta_positive_critique_template: string;
  critique_refine_template: string;
  solve_template: string;
  meta_sample_template: string;
  intent_template: string;
  expert_template: string;
  examples_critique_template: string;
  examples_critique_template_zero_shot: string;
  examples_optimization_template: string;
  generate_reason_template: string;
  reason_optimization_template: string;
}
...
`,
  ...
  initial_prompt_generation_template: `Task Description: {taskDescription}
...
But this prompt gets the following examples wrong: {_examples_}
